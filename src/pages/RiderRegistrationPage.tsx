...
const RiderRegistrationPage: React.FC = () => {
  ...
  const FileUploadField = ({ 
    ...
    <div className="space-y-2">
      ...
      <div className="border-2 border-dashed border-border rounded-lg p-4 text-center hover:border-boda-400 transition-colors bg-background">
        <input
          type="file"
          accept={accept}
          onChange={(e) => {
        ...
        >
          {preview ? (
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 overflow-hidden rounded-md mb-2">
                <img src={preview} alt="Preview" className="w-full h-full object-cover" />
              </div>
              <p className="text-sm font-medium text-green-600 dark:text-green-400 truncate max-w-full px-2">{file?.name}</p>
              <p className="text-xs text-muted-foreground">Click to change</p>
            </div>
          ) : file ? (
            <>
              <Camera className="h-6 w-6 sm:h-8 sm:w-8 text-green-500" />
              <p className="text-sm font-medium text-green-600 dark:text-green-400 truncate max-w-full px-2">{file.name}</p>
              <p className="text-xs text-muted-foreground">Click to change</p>
            </>
          ) : (
  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto mt-4 sm:mt-8 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Become a Boda Rider</h1>

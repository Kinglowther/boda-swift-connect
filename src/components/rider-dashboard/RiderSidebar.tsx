...
import { Star, DollarSign, Package, MapPin, Bike, Settings, LogOut } from 'lucide-react';
...
const RiderSidebar: React.FC<RiderSidebarProps> = ({
  user,
  riderStats,
  isOnline,
  setIsOnline,
  ...
  if (!user) {
    // Or some placeholder/loading state if user is temporarily null during loading
